...
export default function LuxuryFoodSection() {
  const [selectedCategory, setSelectedCategory] = useState("All");
  
  // Get luxury food products from JSON
  const allProducts = productsData.products.filter(p => p.category === "luxury-food");
    ...
    <section className="w-full py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <h2 className="text-2xl font-bold text-black">Luxury Food</h2>
