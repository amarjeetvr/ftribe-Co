...
export default function RealEstateSection() {
  ...
  // Get real estate products from JSON
  const allProducts = productsData.products.filter(p => p.category === "real-estate");
    ...
    <section className="w-full py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <h2 className="text-2xl font-bold text-black">Real Estate</h2>

          <div className="flex items-center justify-between sm:justify-end gap-4 md:gap-8">
            
            {/* MOBILE DROPDOWN */}
            <div className="relative block md:hidden w-full min-w-[150px]">
              <select 
